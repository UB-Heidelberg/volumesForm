...
{block name="page"}
	...
	<tabs :track-history="true">
		...
		<tab id="volumes" label="{translate key="plugins.generic.volumesForm.grid.title"}">
			{capture assign=volumesUrl}{url router=PKPApplication::ROUTE_COMPONENT component="plugins.generic.volumesForm.controllers.grid.VolumeGridHandler" op="fetchGrid" escape=false}{/capture}
